...
$productQuery = "select ps.*,im.*,ct.vName from images im left join products ps on im.iProductId=ps.iProductId left join categories ct on ps.iCategoryId=ct.iCategoryId where tiMarked=1 AND ps.iUserId='" . $user . "'";
...
<head>
  ...
  <script>
    ...
    function updateRow(iProductId) {
      ...
      window.location.href = 'product-update.php?iProductId=' + iProductId + '';
    }
  </script>
  <style>
    .title {
...
<body>
  ...
  <table id="example" class="table table-hover table-bordered" style="width:100%;">
      ...
      <div class="clearfix ">
        <div class="row">
          ...
          <div class="col-md-4 text-right">
            <button class="btn btn-primary  mb-3 float-right"><a href="product.php" class="text-dark">Add Product</a></button>
          </div>
        </div>
      </div>
    </div>
    <thead>
      <tr>
        <th></th>
        <th><input type="text" id="name" style="width:80px" autocomplete="off"></th>
        <th></th>
        <th><input type="text" id="categoryName" style="width:80px" autocomplete="off"></th>
